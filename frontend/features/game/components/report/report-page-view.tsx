...
export function ReportPageEmptyView({
	...
	return (
		<>
			{toolbar}
			<div className="text-center bg-(--app-surface-muted)/80 p-6 sm:p-10 rounded-lg border border-(--app-border)">
				<div className="mx-auto w-12 h-12 rounded-xl bg-(--app-surface) border border-(--app-border) flex items-center justify-center">
					<Clock3 className="w-6 h-6 text-indigo-400" />
				</div>
				<h3 className="mt-4 text-xl font-semibold text-(--app-fg)">
					No sessions found
				</h3>
