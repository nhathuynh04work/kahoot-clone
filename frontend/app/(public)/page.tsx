...
const featureBlocks = [
    ...
    },
    {
        ...
        alt: "Quiz editor preview showing questions and answers",
    },
    {
        title: "AI quiz chatbot",
        body: "Turn notes into questions in seconds. Ask for rephrases, difficulty tweaks, and new variants—then drop them straight into your quiz.",
        src: "/marketing/ai-chatbot.png",
        alt: "AI chatbot generating quiz questions from notes",
    },
    {
        ...
        alt: "Session report preview with per-question stats",
    },
] as const;
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-14 items-center">
                    <div className="space-y-6 order-2 lg:order-1">
                        ...
                        <p className="text-(--app-fg-muted) text-lg max-w-prose leading-relaxed">
                            Draft questions with an AI chatbot, then host live games with a PIN. Players join
                            from their phones while you run the show.
                        </p>
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                            ...
                            <Link
                                href="/auth/register?returnTo=/library/quizzes"
                                className="px-6 py-3 rounded-xl border border-(--app-border) bg-(--app-surface) hover:bg-(--app-surface-muted) text-(--app-fg) font-semibold transition-colors"
                            >
                                Create with AI
                            </Link>
                        </div>
                    ...
                    <div className="order-1 lg:order-2">
                        <Image
                            ...
                            alt="Product preview: host dashboard and live quiz session"
                            width={1200}
                            height={600}
            ...
            <section className="px-4 pb-20 border-t border-(--app-border)">
                <div className="max-w-6xl mx-auto pt-16">
                    <div className="text-center max-w-2xl mx-auto mb-10">
                        <p className="text-xs font-semibold tracking-wide text-amber-600 dark:text-amber-200 uppercase">
                            VIP
                        </p>
                            ...
                            <div className="flex items-start justify-between gap-4">
                                <div className="min-w-0">
                                    <p className="text-sm font-semibold text-(--app-fg) inline-flex items-center gap-2">
                                        VIP
                                        <span className="inline-flex items-center rounded-full border border-amber-500/25 bg-amber-500/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-amber-600 dark:text-amber-200">
                                            Subscription
                                        </span>
                                    </p>
                                    <p className="text-xs text-(--app-fg-muted)/70 mt-1">
